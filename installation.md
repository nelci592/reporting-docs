...
* [
            ...
            [Reporting REST WebAPI-based service](d3912553-a26d-43ca-80c4-136e51d56263) where you can use the packages
...
The following table describes the folder structure for redistributable assemblies.
        

The assemblies for .NET Framework are in the \Bin folder of your installation directory. The assemblies compiled against .NET Standard
          are in \Bin\netstandard2.0 folder. Those for .NET Core are in \Bin\netcoreapp3.1. The ones for .NET 5 are in \Bin\net5.0 and \Bin\net5.0-windows.
