...
You specify the sorting criteria by adding [T:Telerik.Reporting.Sorting]() objects to the data items’ or groups’ Sorting collections. Each sorting is made up of an Expression and a Direction:
