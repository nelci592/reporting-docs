...
All HTML5 Report Viewers now provide Kendo subset version kendosubsetversion that require jQuery 1.12.4 and is also compatible with 1.10.x, 2.2.x and 3.3.1.
            

### Standalone Report Designer

TRDX, TRDP and TRBP files created by the Standalone Report Designer use schema version
              __http://schemas.telerik.com/reporting/2018/3.0__.
            

### WPF Report Viewer

The viewer is build with Telerik UI Controls for WPF __2018.3.911.40__.
