...
1. To localize the report viewer, create a new TypeScript file 
*stringResources.ts
*:
#_TypeScript_
...
The file can contain all or only part of the string resources which would be localized. For a full list of the report viewer string resources
              which could be localized please refer to 
...
1. Implement 
__AfterViewInit
__ and extend the viewer object with the string resources for the desired culture:
