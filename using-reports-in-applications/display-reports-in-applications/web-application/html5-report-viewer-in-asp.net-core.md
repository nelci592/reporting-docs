...
>important The following article applies to .NET Core projects that target the __full .NET Framework 4.0+__ .
>If the project targets .NET Core 2.1+ please refer to the following articles:
>
...
>warning You might exprience issues with displaying images in the report if using ASP.NET Core __1.1.0__ due to the way the requests are handled.
            It is recommended to upgrade to a newer version of ASP.NET Core -[.NET Core releases](https://github.com/dotnet/core/releases)
>
Prerequisites
...
<head>
    ...
    <script src="https://code.jquery.com/jquery-3.3.1.min.js" integrity="sha256-BbhdlvQf/xTY9gja0Dq3HiwQF8LaCRTXxZKRutelT44=" crossorigin="anonymous"></script>

    <link href="https://kendo.cdn.telerik.com/



>important The reference to the report viewer's JavaScript file ( *telerikReportViewer-buildversion.min.js* )
                should be updated to the corresponding version of the Reporting NuGet package.
>
