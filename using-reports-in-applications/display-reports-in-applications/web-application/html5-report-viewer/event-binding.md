...
The HTML5 Report Viewer exposes the events listed in 
...
) - e.data.sender and for all events this is the report viewer.
...
To 
__unbind all event handlers
__ from the event just call the unbind method with only one argument, the event name.
