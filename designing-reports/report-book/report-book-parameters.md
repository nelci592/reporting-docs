...
Telerik Reporting provides a mechanism known as parameter merging.
          If the [Name](/reporting/api/Telerik.Reporting.IReportParameter#collapsible-Telerik_Reporting_IReportParameter_Name)
          and [Type](/reporting/api/Telerik.Reporting.IReportParameter#collapsible-Telerik_Reporting_IReportParameter_Type)
...
You can control parameter merging via the
          [Mergeable](/reporting/api/Telerik.Reporting.IReportParameter#collapsible-Telerik_Reporting_IReportParameter_Mergeable) boolean
