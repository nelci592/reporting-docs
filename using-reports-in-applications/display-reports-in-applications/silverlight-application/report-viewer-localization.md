...
````
{{source=CodeSnippets\SilverlightCS\API\Telerik\ReportViewer\Silverlight\Localization\InterfaceLocalizationSnippets.cs region=InterfaceLocalizationSnippetEnd}}
````C#
	        }
````
...
````VB.NET
	    Public Class CustomResources
	        ...
	        '...... Implement the rest of the properties ......
````
{{source=CodeSnippets\SilverlightVB\API\Telerik\ReportViewer\Silverlight\Localization\InterfaceLocalizationSnippets.vb region=InterfaceLocalizationSnippetEnd}}
````VB.NET
	    End Class
````
...
````C#
	        public class CustomTextResources : Telerik.ReportViewer.Silverlight.ITextResources
	        {
	            ...
	            //...... Implement the rest of the properties ......
````
{{source=CodeSnippets\SilverlightCS\API\Telerik\ReportViewer\Silverlight\Localization\InterfaceLocalizationSnippets.cs region=InterfaceLocalizationUsingMethodsSnippetEnd}}
````C#
...
````VB.NET
	    Public Class CustomTextResources
	        ...
	        '...... Implement the rest of the properties ......
````
{{source=CodeSnippets\SilverlightVB\API\Telerik\ReportViewer\Silverlight\Localization\InterfaceLocalizationSnippets.vb region=InterfaceLocalizationUsingMethodsSnippetEnd}}
````VB.NET
	    End Class
````
