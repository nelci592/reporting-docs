...
The viewer is build with Telerik UI Controls for WPF __2017.2.503.40__. If you are using a newer version consider adding binding redirects. For more information see:
