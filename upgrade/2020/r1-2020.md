...
Versions of Crystal Reports prior to 13.0.2000.0 are not supported by the [Crystal Reports Converter]({%slug telerikreporting/designing-reports/converting-reports-from-other-reporting-solutions/crystal-reports-converter%}).
                  To convert a report from Crystal Reports 2008 SP7 (version 12.0.2000) or earlier, please use a previous version of Telerik Reporting.
...
The viewer is build with Telerik UI Controls for WPF __2020.1.115.40__.
