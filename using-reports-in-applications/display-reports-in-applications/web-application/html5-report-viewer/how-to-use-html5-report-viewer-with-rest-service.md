...
* To start the item template wizard, in __Solution Explorer__, select the target project. On the
              ...
              [Add New Item](https://msdn.microsoft.com/en-us/library/w0572c5b%28v=vs.100%29.aspx)              dialog box, navigate to the __Web__ category and select the __Telerik HTML5 Report Viewer Page__ item.
