...
Generally only some properties of certain report 
      ...
      take advantage of expression values by adding Binding objects to its 
__Bindings 
      collection
__. Only write-enabled properties can be set through binding expressions, 
...
__Style.Font.Bold
__ 
            property of a TextBox item to an expression such as 
__=Fields.MyBoolField
__ that would 
            return 
__true
__ or 
...
__.
            ...
            conversions should be considered e.g. for 
__System.Drawing.Color
__ as seen 
            on the image.
