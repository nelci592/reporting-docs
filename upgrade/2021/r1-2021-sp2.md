...
End User License Agreement (EULA) is updated to include
                [Telerik UI for WinUI](https://www.telerik.com/winui)                 product, which is now official.WPF Report ViewerWPF Report Viewer for .NET Framework

The viewer is built with Telerik UI Controls for WPF __2021.1.325.40__.
