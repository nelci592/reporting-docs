...
* The T:Telerik.Reporting.GenericTileProvider, however, requires the user to provide more information - a template to the
              server URL, the subdomain names (when needed), the attribution text and the URL to the map provider logo should be manually set.
            ...
            The P:Telerik.Reporting.GenericTileProvider.UrlTemplate include the tags
