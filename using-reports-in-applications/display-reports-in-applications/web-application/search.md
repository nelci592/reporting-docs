...
The behavior of the search dialog depends on the __searchMetadataOnDemand__ property.
...
If the __searchMetadataOnDemand__ property is set to
...
* __Results list__ - a list that displays the found results and allows navigating through them.
