...
In the WPF Report Viewer, localized resources are stored in separate 
__RESX
...
Telerik.ReportViewer.WPF.TextResources.
__[culture]
__.resx
...
1.             Telerik.ReportViewer.WPF.TextResources.
__fr-BE
__.resx
...
The other way to localize the WPF 
__*Report Viewer
...
](http://msdn.microsoft.com/en-us/library/ms788718(v=VS.85).aspx
)
