...
__Telerik.ReportDesigner(.x86).exe.config
...
More details about the Standalone Report Designer's configuration file are available in the 
...
__Telerik.ReportDesigner(.x86).exe.config
__ resides in the 
__[InstallDir]/Report Designer
__ directory by default
...
* Use Visual Studio Debugger to attach to the 
__Telerik.ReportDesigner(.x86).exe
__ running process before it crashes,
...
[The report cannot be opened in the Standalone Report Designer
](./knowledge-base/report-cannot-be-opened-in-standalone-report-designer
)
