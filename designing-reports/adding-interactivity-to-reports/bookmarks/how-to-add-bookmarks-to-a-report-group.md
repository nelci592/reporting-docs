...
1. In the [BookmarkId](/reporting/api/Telerik.Reporting.Group#collapsible-Telerik_Reporting_Group_BookmarkId) property, 
...
>note The [BookmarkId](/reporting/api/Telerik.Reporting.Group#collapsible-Telerik_Reporting_Group_BookmarkId) can be any 	string, but it must be unique in the report. If the  __BookmarkID__  is not unique,	an action to the bookmark finds the first matching bookmark.
