...
|PrintAs(format)| __format:__ 

*  __"PDF":__ uses the Adobe PDF Reader add-on.

*  __"Default":__ uses the default printing capabilities of the browser.|Forces the viewer to print the document according to the specified print *format* .|
