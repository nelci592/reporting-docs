...
.NET Core don't have design time support.
          ...
          (Class Library created for .NET Framework 4.0+) or to use the 
...
1. Right click on the unloaded project and select 'Edit 
*YourProjectName
*.csproj'. The .csproj file opens in the VS for editing.
...
* (for example 
*4.7.1
*) the value should be changed accordingly (for the example - 
*net471
*), etc.
...
To setup the Reporting REST service download 
__Telerik.Reporting
__          and 
...
) is required to access the private repository.
...
](https://www.nuget.org/packages/Microsoft.AspNetCore.StaticFiles/
)          NuGet package.
...
__.
              Name the folder 
__Reports
__ and add sample reports in TRDP format. Find the sample reports in
